    ...
    >
      ...
      >
        ...
        <div style={{ border: '1px solid #1a1a1a', padding: '1px 3px', marginBottom: '1px' }}>
          <div style={{ display: 'flex', gap: '3px', fontSize: '7.5px', lineHeight: 1.6, flexWrap: 'wrap', alignItems: 'center' }}>
            <span style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }}>客戶名稱：</span>
            <span style={{ borderBottom: '1px dotted #aaa', minWidth: '100px' }}>{shipment.customer?.name || '-'}</span>
          ...
          <div style={{ display: 'flex', gap: '3px', fontSize: '7.5px', lineHeight: 1.6, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <span style={{ borderBottom: '1px dotted #aaa', minWidth: '70px' }}>{shipment.customer?.tax_id || '-'}</span>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '8px' }}>
            ...
            <tbody>
              ...
              {items.length < 3 && Array.from({ length: Math.max(0, 3 - items.length) }).map((_, i) => (
                <tr key={`e${i}`}>
                  <td style={{ ...td, height: '12px' }}></td>
                  <td style={{ ...td, height: '12px', textAlign: 'center' }}></td>
                  <td style={{ ...td, height: '12px', textAlign: 'center' }}></td>
                  <td style={{ ...td, height: '12px', textAlign: 'right' }}></td>
                  <td style={{ ...td, height: '12px', textAlign: 'right' }}></td>
                </tr>
              ))}
              <tr>
                ...
                <td style={td}></td>
                <td style={td}></td>
                <td style={{ ...td, textAlign: 'right', fontWeight: 'bold', fontSize: '9px' }}>
        ...
        {/* ── 備註 ── */}
        <div style={{ border: '1px solid #1a1a1a', padding: '1px 3px', marginBottom: '1px' }}>
          <div style={{ fontWeight: 'bold', marginBottom: '0.5px', fontSize: '7.5px' }}>備　註：</div>
          <div style={{ fontSize: '7px', lineHeight: 1.3 }}>
            玉山銀行（808）豐原分行　帳號：0381440003611　戶名：嘉祐資訊企業有限公司
          </div>
          {shipment.note && (
            <div style={{ fontSize: '7px', marginTop: '1px', lineHeight: 1.3, color: '#444' }}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', border: '1px solid #1a1a1a' }}>
          <div style={{ padding: '1px 3px', borderRight: '1px solid #1a1a1a' }}>
            <div style={{ fontWeight: 'bold', fontSize: '7.5px', letterSpacing: '2px' }}>工程師</div>
            <div style={{ borderBottom: '1px solid #1a1a1a', height: '10px', marginTop: '1px' }}></div>
          </div>
          <div style={{ padding: '1px 3px', borderRight: '1px solid #1a1a1a' }}>
            <div style={{ fontWeight: 'bold', fontSize: '7.5px', letterSpacing: '2px' }}>客戶簽名</div>
            <div style={{ borderBottom: '1px solid #1a1a1a', height: '10px', marginTop: '1px' }}></div>
          </div>
          <div style={{ padding: '1px 3px' }}>
            <div style={{ fontWeight: 'bold', fontSize: '7.5px', letterSpacing: '2px' }}>日　期</div>
            <div style={{ borderBottom: '1px solid #1a1a1a', height: '10px', marginTop: '1px' }}></div>
          </div>
        </div>
      </div>
